...
bool AShooterWeapon_Instant::ServerNotifyMiss_Validate(struct FVector_NetQuantizeNormal, int, float)
{
	return(true);
}
...
bool AShooterWeapon_Instant::ServerNotifyHit_Validate(struct FHitResult const&, struct FVector_NetQuantizeNormal, int, float)
{
	return(true);
}
